...
void FillHistogram(TH1F* hist1_1, TH1F* hist1_2, TH1F* hist1_3, TH1F* hist1_4, TH1F* hist1_5, TH1F* hist1_6, TH1F* hist1_7, TH1F* hist1_8, TH1F* hist1_9, TH1F* hist1_10,
										...
										TString filename,
										int mode, int ifile, std::string outpath) {
											
		// Open GBDT file
		BoosterHandle h_booster;
    DMatrixHandle h_test;
		XGBoosterCreate(NULL, 0, &h_booster);
		// XGBoosterLoadModel(h_booster, "/eos/home-x/xuyan/RKProj/RKAnalyzer/KStarllStudy/Analyzer_KstarBDT/model_trk0p5_eta1p4_cos0p8_SRm4p7-5p7_CV10_BayesianOptimization_33var.bin");
		XGBoosterLoadModel(h_booster, "model_trk0p5_eta1p4_cos0p8_SRm5-5p4_CV6_BayesianOptimization_33var_fold_0.bin");
    // Open the ROOT file
    ...
    if(!tree) {
		...
		// TString outname = "/eos/cms/store/group/phys_bphys/DiElectronX/sgottlie/BDT4/samesign/outputTree_" + std::to_string(ifile) + ".root";
		TString outname = outpath + "outputTree_" + std::to_string(ifile) + ".root";
		...
		// Int_t output_run;
		// Int_t output_luminosityBlock;
		// Int_t output_event;
		// Int_t output_bunchCrossing;
		// std::vector<Float_t> output_BCand_mass_fullfit;
		// std::vector<Float_t> output_BCand_massErr_fullfit;
		// std::vector<Float_t> output_BCand_mll_fullfit_norm;
		// std::vector<Float_t> output_BCand_mll_fullfit;
		// std::vector<Float_t> output_BCand_mll_charge;
		// std::vector<Float_t> output_BCand_fit_l1_pt_norm;
		// std::vector<Float_t> output_BCand_fit_l2_pt_norm;
		// std::vector<Float_t> output_BCand_fit_trk1_pt_norm;
		// std::vector<Float_t> output_BCand_fit_trk2_pt_norm;
		// std::vector<Float_t> output_BCand_fit_l1_pt;
		// std::vector<Float_t> output_BCand_fit_l1_eta;
		// std::vector<Float_t> output_BCand_fit_l1_phi;
		// std::vector<Float_t> output_BCand_fit_l2_pt;
                // std::vector<Float_t> output_BCand_fit_l2_eta;
                // std::vector<Float_t> output_BCand_fit_l2_phi;
		// std::vector<Int_t> output_BCand_l1Idx;
		// std::vector<Int_t> output_BCand_l2Idx;
		// std::vector<Int_t> output_BCand_kIdx;
		// std::vector<Float_t> output_BCand_fit_trk1_pt;
                // std::vector<Float_t> output_BCand_fit_trk1_eta;
                // std::vector<Float_t> output_BCand_fit_trk1_phi;
		// std::vector<Float_t> output_BCand_fit_trk2_pt;
		// std::vector<Float_t> output_BCand_fit_pt_norm;
		// std::vector<Float_t> output_BCand_fit_pt;
		// std::vector<Float_t> output_BCand_fit_eta;
		// std::vector<Float_t> output_BCand_fit_phi;
		// std::vector<Float_t> output_BCand_fit_cos2D;
		// std::vector<Float_t> output_BCand_cosAlpha3D;
		// std::vector<Float_t> output_BCand_svprob;
		// std::vector<Float_t> output_BCand_Lxy;
		// std::vector<Float_t> output_BCand_Lxy_unc;
		// std::vector<Float_t> output_BCand_sigLxy;
		// std::vector<Float_t> output_BCand_dR_ll;
		// std::vector<Float_t> output_BCand_MomenAsym_lltrk1;
		// std::vector<Float_t> output_BCand_MomenAsym_lltrk2;
		// std::vector<Float_t> output_BCand_MomenAsym_llKs;
		// std::vector<Float_t> output_BCand_iso04_l1_norm;
		// std::vector<Float_t> output_BCand_iso04_l2_norm;
		// std::vector<Float_t> output_BCand_iso04_l1;
		// std::vector<Float_t> output_BCand_iso04_l2;
		// std::vector<Float_t> output_BCand_iso04_trk1_norm;
		// std::vector<Float_t> output_BCand_iso04_trk2_norm;
		// std::vector<Float_t> output_BCand_iso04_trk1;
		// std::vector<Float_t> output_BCand_iso04;
		// std::vector<Float_t> output_BCand_sigImpact_lltrk1;
		// std::vector<Float_t> output_BCand_sigImpact_lltrk2;
		// std::vector<Float_t> output_BCand_dR_l1trk1;
		// std::vector<Float_t> output_BCand_dR_l1trk2;
		// std::vector<Float_t> output_BCand_dR_l2trk1;
		// std::vector<Float_t> output_BCand_dR_l2trk2;
		// std::vector<Float_t> output_BCand_dR_trk1trk2;
		// std::vector<Float_t> output_BCand_dz_l1trk1;
		// std::vector<Float_t> output_BCand_dz_l1trk2;
		// std::vector<Float_t> output_BCand_dz_l2trk1;
		// std::vector<Float_t> output_BCand_dz_l2trk2;
		// std::vector<Float_t> output_BCand_dz_trk1trk2;
		// std::vector<Float_t> output_BCand_l1_ID;
		// std::vector<Float_t> output_BCand_l2_ID;
		// std::vector<Float_t> output_BCand_vtx_x;
		// std::vector<Float_t> output_BCand_vtx_y;
		// std::vector<Float_t> output_BCand_vtx_z;
		// std::vector<Float_t> output_BCand_k_svip3d;
		// std::vector<Float_t> output_BCand_k_svip3d_err;
		// std::vector<Int_t> output_Electron_charge;
		// std::vector<Float_t> output_Electron_pt;
                // std::vector<Float_t> output_Electron_eta;
                // std::vector<Float_t> output_Electron_phi;
    		// std::vector<Bool_t> output_Electron_isPF;
		// std::vector<Bool_t> output_Electron_isPFoverlap;
		// std::vector<Bool_t> output_Electron_convVeto;
		// std::vector<Bool_t> output_Electron_PFEleMvaID_Fall17NoIsoV2wp80;
		// std::vector<Bool_t> output_Electron_PFEleMvaID_Fall17NoIsoV2wp90;
		// std::vector<Bool_t> output_Electron_PFEleMvaID_Fall17NoIsoV2wpLoose;
                // std::vector<Float_t> output_Electron_PFEleMvaID_RetrainedRawValue;
		// std::vector<Float_t> output_Electron_PFEleMvaID_Fall17NoIsoV2RawValue;
                // std::vector<Float_t> output_Electron_vz;
                // std::vector<Float_t> output_ProbeTracks_pt;
                // std::vector<Float_t> output_ProbeTracks_eta;
                // std::vector<Float_t> output_ProbeTracks_phi;
                // std::vector<Float_t> output_ProbeTracks_vz;
                // Float_t output_PV_x;
                // Float_t output_PV_y;
                // Float_t output_PV_z;
                // UChar_t output_L1_DoubleEG11_er1p2_dR_Max0p6;
                // UChar_t output_L1_DoubleEG10p5_er1p2_dR_Max0p6;
                // UChar_t output_L1_DoubleEG10_er1p2_dR_Max0p6;
                // UChar_t output_L1_DoubleEG9p5_er1p2_dR_Max0p6;
                // UChar_t output_L1_DoubleEG9_er1p2_dR_Max0p7;
                // UChar_t output_L1_DoubleEG8p5_er1p2_dR_Max0p7;
                // UChar_t output_L1_DoubleEG8_er1p2_dR_Max0p7;
                // UChar_t output_L1_DoubleEG7p5_er1p2_dR_Max0p7;
                // UChar_t output_L1_DoubleEG7_er1p2_dR_Max0p8;
                // UChar_t output_L1_DoubleEG6p5_er1p2_dR_Max0p8;
                // UChar_t output_L1_DoubleEG6_er1p2_dR_Max0p8;
                // UChar_t output_L1_DoubleEG5p5_er1p2_dR_Max0p8;
                // UChar_t output_L1_DoubleEG5_er1p2_dR_Max0p9;
		// UChar_t output_L1_DoubleEG4p5_er1p2_dR_Max0p9;
                // UChar_t output_L1_DoubleEG4_er1p2_dR_Max0p9;
                // UChar_t output_HLT_DoubleEle10_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle9p5_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle9_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle8p5_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle8_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle7p5_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle7_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle6p5_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle6_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle5p5_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle5_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle4p5_eta1p22_mMax6;
                // UChar_t output_HLT_DoubleEle4_eta1p22_mMax6;
		// Int_t output_BCand_evt_nQuad;
		// Int_t output_BCand_evt_nTri;
		// Int_t output_nElectron;
		// Int_t output_nProbeTracks;
		// Int_t output_nSV;
		// Int_t output_nTrigObj;
	
		Float_t output_BCand_quad_BDT = 0;
		// Float_t* quad_BDT_scores = new Float_t[1000];
		vector<Float_t> quad_BDT_scores; 
		
		// outputTree->Branch("run", &output_run, "run/i");
		// outputTree->Branch("luminosityBlock", &output_luminosityBlock, "luminosityBlock/i");
		// outputTree->Branch("event", &output_event, "event/l");
		// outputTree->Branch("bunchCrossing", &output_bunchCrossing, "bunchCrossing/i");
		// outputTree->Branch("nBToKEE", &output_BCand_evt_nTri, "nBToKEE/I");
                // outputTree->Branch("nBToKsEE", &output_BCand_evt_nQuad, "nBToKsEE/I");
		// outputTree->Branch("nElectron", &output_nElectron, "nElectron/I");
                // outputTree->Branch("nProbeTracks", &output_nProbeTracks, "nProbeTracks/I");
		// outputTree->Branch("nSV", &output_nSV, "nSV/I");
		// outputTree->Branch("nTrigObj", &output_nTrigObj, "nTrigObj/I");
		// outputTree->Branch("BToKEE_fit_mass", &output_BCand_mass_fullfit);
		// outputTree->Branch("BToKEE_fit_massErr", &output_BCand_massErr_fullfit);
		// outputTree->Branch("BToKEE_fit_mll_norm", &output_BCand_mll_fullfit_norm);
		// outputTree->Branch("BToKEE_mll_fullfit", &output_BCand_mll_fullfit);
		// outputTree->Branch("BToKEE_fit_mll_charge", &output_BCand_mll_charge);
    		// outputTree->Branch("BToKEE_fit_l1_pt_norm", &output_BCand_fit_l1_pt_norm);
    		// outputTree->Branch("BToKEE_fit_l2_pt_norm", &output_BCand_fit_l2_pt_norm);
    		// outputTree->Branch("BToKEE_fit_trk1_pt_norm", &output_BCand_fit_trk1_pt_norm);
		// outputTree->Branch("BToKEE_fit_trk2_pt_norm", &output_BCand_fit_trk2_pt_norm);
		// outputTree->Branch("BToKEE_fit_l1_pt", &output_BCand_fit_l1_pt);
		// outputTree->Branch("BToKEE_fit_l1_eta", &output_BCand_fit_l1_eta);
		// outputTree->Branch("BToKEE_fit_l1_phi", &output_BCand_fit_l1_phi);
    		// outputTree->Branch("BToKEE_fit_l2_pt", &output_BCand_fit_l2_pt);
                // outputTree->Branch("BToKEE_fit_l2_eta", &output_BCand_fit_l2_eta);
                // outputTree->Branch("BToKEE_fit_l2_phi", &output_BCand_fit_l2_phi);
    		// outputTree->Branch("BToKEE_fit_k_pt", &output_BCand_fit_trk1_pt);
		// outputTree->Branch("BToKEE_fit_k_eta", &output_BCand_fit_trk1_eta);
		// outputTree->Branch("BToKEE_fit_k_phi", &output_BCand_fit_trk1_phi);
		// outputTree->Branch("BToKEE_fit_trk2_pt", &output_BCand_fit_trk1_pt);
		// outputTree->Branch("BToKEE_l1Idx", &output_BCand_l1Idx);
		// outputTree->Branch("BToKEE_l2Idx", &output_BCand_l2Idx);
		// outputTree->Branch("BToKEE_kIdx", &output_BCand_kIdx);
		// outputTree->Branch("BToKEE_fit_pt", &output_BCand_fit_pt);
		// outputTree->Branch("BToKEE_fit_eta", &output_BCand_fit_eta);
		// outputTree->Branch("BToKEE_fit_phi", &output_BCand_fit_phi);
    		// outputTree->Branch("BToKEE_fit_pt_norm", &output_BCand_fit_pt_norm);
		// outputTree->Branch("BToKEE_fit_cos2D", &output_BCand_fit_cos2D);
    		// outputTree->Branch("BToKEE_cosAlpha3D", &output_BCand_cosAlpha3D);
    		// outputTree->Branch("BToKEE_svprob", &output_BCand_svprob);
		// outputTree->Branch("BToKEE_l_xy", &output_BCand_Lxy);
		// outputTree->Branch("BToKEE_l_xy_unc", &output_BCand_Lxy_unc);
    		// outputTree->Branch("BToKEE_sigLxy", &output_BCand_sigLxy);
		// outputTree->Branch("BToKEE_dR_ll", &output_BCand_dR_ll);
		// outputTree->Branch("BToKEE_MomenAsym_lltrk1", &output_BCand_MomenAsym_lltrk1);
		// outputTree->Branch("BToKEE_MomenAsym_lltrk2", &output_BCand_MomenAsym_lltrk2);
		// outputTree->Branch("BToKEE_MomenAsym_llKs", &output_BCand_MomenAsym_llKs);
		// outputTree->Branch("BToKEE_l1_iso04", &output_BCand_iso04_l1);
                // outputTree->Branch("BToKEE_l2_iso04", &output_BCand_iso04_l2);
                // outputTree->Branch("BToKEE_k_iso04", &output_BCand_iso04_trk1);
                // outputTree->Branch("BToKEE_b_iso04", &output_BCand_iso04);
		// outputTree->Branch("BToKEE_iso04_l1_norm", &output_BCand_iso04_l1_norm);
    		// outputTree->Branch("BToKEE_iso04_l2_norm", &output_BCand_iso04_l2_norm);
    		// outputTree->Branch("BToKEE_iso04_trk1_norm", &output_BCand_iso04_trk1_norm);
		// outputTree->Branch("BToKEE_iso04_trk2_norm", &output_BCand_iso04_trk2_norm);
		// outputTree->Branch("BToKEE_sigImpact_lltrk1", &output_BCand_sigImpact_lltrk1);
		// outputTree->Branch("BToKEE_sigImpact_lltrk2", &output_BCand_sigImpact_lltrk2);
		// outputTree->Branch("BToKEE_dR_l1trk1", &output_BCand_dR_l1trk1);
    		// outputTree->Branch("BToKEE_dR_l1trk2", &output_BCand_dR_l1trk2);
		// outputTree->Branch("BToKEE_dR_l2trk1", &output_BCand_dR_l2trk1);
    		// outputTree->Branch("BToKEE_dR_l2trk2", &output_BCand_dR_l2trk2);
		// outputTree->Branch("BToKEE_dR_trk1trk2", &output_BCand_dR_trk1trk2);
    		// outputTree->Branch("BToKEE_dz_l1trk1", &output_BCand_dz_l1trk1);
    		// outputTree->Branch("BToKEE_dz_l1trk2", &output_BCand_dz_l1trk2);
		// outputTree->Branch("BToKEE_dz_l2trk1", &output_BCand_dz_l2trk1);
    		// outputTree->Branch("BToKEE_dz_l2trk2", &output_BCand_dz_l2trk2);
		// outputTree->Branch("BToKEE_dz_trk1trk2", &output_BCand_dz_trk1trk2);
		// outputTree->Branch("BToKEE_l1_ID", &output_BCand_l1_ID);
		// outputTree->Branch("BToKEE_l2_ID", &output_BCand_l2_ID);
		// outputTree->Branch("BToKEE_vtx_x", &output_BCand_vtx_x);
		// outputTree->Branch("BToKEE_vtx_y", &output_BCand_vtx_y);
		// outputTree->Branch("BToKEE_vtx_z", &output_BCand_vtx_z);
    		// outputTree->Branch("BToKEE_k_svip3d", &output_BCand_k_svip3d);
		// outputTree->Branch("BToKEE_k_svip3d_err", &output_BCand_k_svip3d_err);
		// outputTree->Branch("Electron_charge", &output_Electron_charge);
                // outputTree->Branch("Electron_pt", &output_Electron_pt);
                // outputTree->Branch("Electron_eta", &output_Electron_eta);
                // outputTree->Branch("Electron_phi", &output_Electron_phi);
    		// // outputTree->Branch("Electron_isPF", &output_Electron_isPF);
		// // outputTree->Branch("Electron_isPFoverlap", &output_Electron_isPFoverlap);
		// // outputTree->Branch("Electron_convVeto", &output_Electron_convVeto);
		// // outputTree->Branch("Electron_PFEleMvaID_Fall17NoIsoV2wp80", &output_Electron_PFEleMvaID_Fall17NoIsoV2wp80);
		// // outputTree->Branch("Electron_PFEleMvaID_Fall17NoIsoV2wp90", &output_Electron_PFEleMvaID_Fall17NoIsoV2wp90);
    		// // outputTree->Branch("Electron_PFEleMvaID_Fall17NoIsoV2wpLoose", &output_Electron_PFEleMvaID_Fall17NoIsoV2wpLoose);
                // outputTree->Branch("Electron_PFEleMvaID_RetrainedRawValue", &output_Electron_PFEleMvaID_RetrainedRawValue);
		// outputTree->Branch("Electron_PFEleMvaID_RetrainedFall17NoIsoV2RawValue", &output_Electron_PFEleMvaID_Fall17NoIsoV2RawValue);
                // outputTree->Branch("Electron_vz", &output_Electron_vz);
                // outputTree->Branch("ProbeTracks_pt", &output_ProbeTracks_pt);
                // outputTree->Branch("ProbeTracks_eta", &output_ProbeTracks_eta);
                // outputTree->Branch("ProbeTracks_phi", &output_ProbeTracks_phi);
                // outputTree->Branch("ProbeTracks_vz", &output_ProbeTracks_vz);
                // outputTree->Branch("PV_x", &output_PV_x, "PV_x/F");
                // outputTree->Branch("PV_y", &output_PV_y, "PV_y/F");
                // outputTree->Branch("PV_z", &output_PV_z, "PV_z/F");
		// outputTree->Branch("L1_DoubleEG11_er1p2_dR_Max0p6", &output_L1_DoubleEG11_er1p2_dR_Max0p6, "L1_DoubleEG11_er1p2_dR_Max0p6/b");
                // outputTree->Branch("L1_DoubleEG10p5_er1p2_dR_Max0p6", &output_L1_DoubleEG10p5_er1p2_dR_Max0p6, "L1_DoubleEG10p5_er1p2_dR_Max0p6/b");
                // outputTree->Branch("L1_DoubleEG10_er1p2_dR_Max0p6", &output_L1_DoubleEG10_er1p2_dR_Max0p6, "L1_DoubleEG10_er1p2_dR_Max0p6/b");
                // outputTree->Branch("L1_DoubleEG9p5_er1p2_dR_Max0p6", &output_L1_DoubleEG9p5_er1p2_dR_Max0p6, "L1_DoubleEG9p5_er1p2_dR_Max0p6/b");
                // outputTree->Branch("L1_DoubleEG9_er1p2_dR_Max0p7", &output_L1_DoubleEG9_er1p2_dR_Max0p7, "L1_DoubleEG9_er1p2_dR_Max0p7/b");
                // outputTree->Branch("L1_DoubleEG8p5_er1p2_dR_Max0p7", &output_L1_DoubleEG8p5_er1p2_dR_Max0p7, "L1_DoubleEG8p5_er1p2_dR_Max0p7/b");
                // outputTree->Branch("L1_DoubleEG8_er1p2_dR_Max0p7", &output_L1_DoubleEG8_er1p2_dR_Max0p7, "L1_DoubleEG8_er1p2_dR_Max0p7/b");
                // outputTree->Branch("L1_DoubleEG7p5_er1p2_dR_Max0p7", &output_L1_DoubleEG7p5_er1p2_dR_Max0p7, "L1_DoubleEG7p5_er1p2_dR_Max0p7/b");
                // outputTree->Branch("L1_DoubleEG7_er1p2_dR_Max0p8", &output_L1_DoubleEG7_er1p2_dR_Max0p8, "L1_DoubleEG7_er1p2_dR_Max0p8/b");
                // outputTree->Branch("L1_DoubleEG6p5_er1p2_dR_Max0p8", &output_L1_DoubleEG6p5_er1p2_dR_Max0p8, "L1_DoubleEG6p5_er1p2_dR_Max0p8/b");
                // outputTree->Branch("L1_DoubleEG6_er1p2_dR_Max0p8", &output_L1_DoubleEG6_er1p2_dR_Max0p8, "L1_DoubleEG6_er1p2_dR_Max0p8/b");
                // outputTree->Branch("L1_DoubleEG5p5_er1p2_dR_Max0p8", &output_L1_DoubleEG5p5_er1p2_dR_Max0p8, "L1_DoubleEG5p5_er1p2_dR_Max0p8/b");
                // outputTree->Branch("L1_DoubleEG5_er1p2_dR_Max0p9", &output_L1_DoubleEG5_er1p2_dR_Max0p9, "L1_DoubleEG5_er1p2_dR_Max0p9/b");
                // outputTree->Branch("L1_DoubleEG4p5_er1p2_dR_Max0p9", &output_L1_DoubleEG4p5_er1p2_dR_Max0p9, "L1_DoubleEG4p5_er1p2_dR_Max0p9/b");
                // outputTree->Branch("L1_DoubleEG4_er1p2_dR_Max0p9", &output_L1_DoubleEG4_er1p2_dR_Max0p9, "L1_DoubleEG4_er1p2_dR_Max0p9/b");
                // outputTree->Branch("HLT_DoubleEle10_eta1p22_mMax6", &output_HLT_DoubleEle10_eta1p22_mMax6, "HLT_DoubleEle10_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle9p5_eta1p22_mMax6", &output_HLT_DoubleEle9p5_eta1p22_mMax6, "HLT_DoubleEle9p5_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle9_eta1p22_mMax6", &output_HLT_DoubleEle9_eta1p22_mMax6, "HLT_DoubleEle9_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle8p5_eta1p22_mMax6", &output_HLT_DoubleEle8p5_eta1p22_mMax6, "HLT_DoubleEle8p5_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle8_eta1p22_mMax6", &output_HLT_DoubleEle8_eta1p22_mMax6, "HLT_DoubleEle8_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle7p5_eta1p22_mMax6", &output_HLT_DoubleEle7p5_eta1p22_mMax6, "HLT_DoubleEle7p5_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle7_eta1p22_mMax6", &output_HLT_DoubleEle7_eta1p22_mMax6, "HLT_DoubleEle7_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle6p5_eta1p22_mMax6", &output_HLT_DoubleEle6p5_eta1p22_mMax6, "HLT_DoubleEle6p5_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle6_eta1p22_mMax6", &output_HLT_DoubleEle6_eta1p22_mMax6, "HLT_DoubleEle6_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle5p5_eta1p22_mMax6", &output_HLT_DoubleEle5p5_eta1p22_mMax6, "HLT_DoubleEle5p5_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle5_eta1p22_mMax6", &output_HLT_DoubleEle5_eta1p22_mMax6, "HLT_DoubleEle5_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle4p5_eta1p22_mMax6", &output_HLT_DoubleEle4p5_eta1p22_mMax6, "HLT_DoubleEle4p5_eta1p22_mMax6/b");
                // outputTree->Branch("HLT_DoubleEle4_eta1p22_mMax6", &output_HLT_DoubleEle4_eta1p22_mMax6, "HLT_DoubleEle4_eta1p22_mMax6/b");

		outputTree->Branch("BToKEE_quad_BDT", &quad_BDT_scores);
		//outputTree->Branch("BToKEE_quad_BDT", &quad_BDT_scores[0], "quad_BDT_scores[nBToKEE]/F");
    ...
    for(Long64_t ievt = 0; ievt < numEntries; ++ievt) {
        ...
        tree->GetEntry(ievt);
				...
				// output_run = *run;
		                // output_luminosityBlock = *luminosityBlock;
		                // output_event = *event;
		                // output_bunchCrossing = *bunchCrossing;
		                // output_BCand_evt_nTri = *nBToKEE;
		                // output_BCand_evt_nQuad = *nBToKsEE;
				// output_nElectron = *nElectron;
				// output_nProbeTracks = *nProbeTracks;
				// output_nSV = *nSV;
				// output_nTrigObj = *nTrigObj;

				quad_BDT_scores.clear();
				...
				for(size_t iB = 0; iB < BToKEE_mass.GetSize(); ++iB) {
					...
					// if(abs(ProbeTracks_eta[k_index]) > 1.4) continue;
					// counter10++;
					// if(BToKEE_fit_cos2D[iB] < 0.8) continue;
					counter11++;
					...
					for(size_t iBKStaree = 0; iBKStaree < BToKsEE_mass.GetSize(); ++iBKStaree) {
							if((BToKsEE_l1_idx[iBKStaree] == l1_index && BToKsEE_l2_idx[iBKStaree] == l2_index && BToKsEE_trk1_idx[iBKStaree] == k_index) ||
								...
								(BToKsEE_l1_idx[iBKStaree] == l2_index && BToKsEE_l2_idx[iBKStaree] == l1_index && BToKsEE_trk2_idx[iBKStaree] == k_index)) {
										...
										// if(abs(ProbeTracks_eta[trk1_Ks_index]) > 1.4 || abs(ProbeTracks_eta[trk2_Ks_index]) > 1.4) {continue;}
										// if(BToKsEE_fit_cos2D[iBKStaree] < 0.8) continue;
										...
										// cout<<"----"<<ievt<<" "<<iBKStaree<<" "<<f[0]<<" "<<BToKsEE_fit_mass[iBKStaree]<<" "<<l1_Ks_index<<" "<<l2_Ks_index<<" "<<trk1_Ks_index<<" "<<trk2_Ks_index<<endl;
								 }
					}
					...
					quad_BDT_scores.push_back(output_BCand_quad_BDT);
					...
					// output_BCand_mass_fullfit.push_back(BToKEE_fit_mass[iB]);
					// hist1_1->Fill(output_BCand_mass_fullfit[iB]); 

					// output_BCand_massErr_fullfit.push_back(BToKEE_fit_massErr[iB]);

					// output_BCand_mll_fullfit.push_back(BToKEE_mll_fullfit[iB]);
					// hist1_2->Fill(output_BCand_mll_fullfit[iB]);
					// 
					// output_BCand_mll_fullfit_norm.push_back(BToKEE_mll_fullfit[iB] / BToKEE_fit_mass[iB]);
					// hist1_3->Fill(output_BCand_mll_fullfit_norm[iB]);
				
                                        // output_BCand_mll_charge.push_back(BToKEE_mll_charge[iB]);
                                        // hist1_43->Fill(output_BCand_mll_charge[iB]);

					// output_BCand_fit_l1_pt.push_back(BToKEE_fit_l1_pt[iB]);
					// hist1_4->Fill(output_BCand_fit_l1_pt[iB]);

					// output_BCand_fit_l1_eta.push_back(BToKEE_fit_l1_eta[iB]);
					// hist1_48->Fill(output_BCand_fit_l1_eta[iB]);

					// output_BCand_fit_l1_phi.push_back(BToKEE_fit_l1_phi[iB]);
					// hist1_49->Fill(output_BCand_fit_l1_phi[iB]);

					// output_BCand_fit_l2_pt.push_back(BToKEE_fit_l2_pt[iB]);
                                        // hist1_5->Fill(output_BCand_fit_l2_pt[iB]);

					// output_BCand_fit_l2_eta.push_back(BToKEE_fit_l2_eta[iB]);
					// hist1_50->Fill(output_BCand_fit_l2_eta[iB]);

					// output_BCand_fit_l2_phi.push_back(BToKEE_fit_l2_phi[iB]);
					// hist1_51->Fill(output_BCand_fit_l2_phi[iB]); 

					// output_BCand_fit_l1_pt_norm.push_back(BToKEE_fit_l1_pt[iB] / BToKEE_fit_mass[iB]);
					// hist1_6->Fill(output_BCand_fit_l1_pt_norm[iB]);
					// 
					// output_BCand_fit_l2_pt_norm.push_back(BToKEE_fit_l2_pt[iB] / BToKEE_fit_mass[iB]);
					// hist1_7->Fill(output_BCand_fit_l2_pt_norm[iB]); 
				
					// output_BCand_fit_trk1_pt.push_back(BToKEE_fit_k_pt[iB]);
					// hist1_8->Fill(output_BCand_fit_trk1_pt[iB]); 
	
					// output_BCand_fit_trk1_eta.push_back(BToKEE_fit_k_eta[iB]);
                                        // // hist1_->Fill(output_BCand_fit_trk1_eta[iB]);

                                        // output_BCand_fit_trk1_phi.push_back(BToKEE_fit_k_phi[iB]);
                                        // // hist1_->Fill(output_BCand_fit_trk1_phi[iB]);
					// 
					// output_BCand_fit_trk2_pt.push_back(0);
					// hist1_9->Fill(output_BCand_fit_trk2_pt[iB]); 
					// 
					// output_BCand_fit_trk1_pt_norm.push_back(BToKEE_fit_k_pt[iB] / BToKEE_fit_mass[iB]);
					// hist1_10->Fill(output_BCand_fit_trk1_pt_norm[iB]); 
					// 
					// output_BCand_fit_trk2_pt_norm.push_back(0);
					// hist1_11->Fill(output_BCand_fit_trk2_pt_norm[iB]); 
					// 
					// output_BCand_fit_pt.push_back(BToKEE_fit_pt[iB]);
					// hist1_12->Fill(output_BCand_fit_pt[iB]);
					// 
					// output_BCand_fit_pt_norm.push_back(BToKEE_fit_pt[iB] / BToKEE_fit_mass[iB]);
					// hist1_13->Fill(output_BCand_fit_pt_norm[iB]); 
					// 
					// output_BCand_cosAlpha3D.push_back(BVtxVector.Dot(Bp3Vector) / (BVtxVector.R() * Bp3Vector.R()));
					// hist1_14->Fill(output_BCand_cosAlpha3D[iB]); 
					// 
					// output_BCand_svprob.push_back(BToKEE_svprob[iB]);
					// hist1_15->Fill(output_BCand_svprob[iB]); 

					// output_BCand_sigLxy.push_back(BToKEE_l_xy[iB] / BToKEE_l_xy_unc[iB]);
					// hist1_16->Fill(output_BCand_sigLxy[iB]);
					// 
					// output_BCand_fit_cos2D.push_back(BToKEE_fit_cos2D[iB]);
					// hist1_17->Fill(output_BCand_fit_cos2D[iB]); 
					// 
					// output_BCand_MomenAsym_lltrk1.push_back(((llp3Vector.Cross(unitBVtxVector)).R() - (Kp3Vector.Cross(unitBVtxVector)).R()) / ((llp3Vector.Cross(unitBVtxVector)).R() + (Kp3Vector.Cross(unitBVtxVector)).R()));
					// hist1_18->Fill(output_BCand_MomenAsym_lltrk1[iB]);
					// 
					// output_BCand_MomenAsym_lltrk2.push_back(1);
					// hist1_19->Fill(output_BCand_MomenAsym_lltrk2[iB]);
					// 
					// output_BCand_MomenAsym_llKs.push_back(1);
					// hist1_20->Fill(output_BCand_MomenAsym_llKs[iB]);
					// 
					// output_BCand_sigImpact_lltrk1.push_back(BToKEE_k_svip3d[iB]/BToKEE_k_svip3d_err[iB]);
					// hist1_21->Fill(output_BCand_sigImpact_lltrk1[iB]); 
					// 
					// output_BCand_sigImpact_lltrk2.push_back(-1);
					// hist1_22->Fill(output_BCand_sigImpact_lltrk2[iB]);
					// 
					// output_BCand_iso04_l1_norm.push_back(BToKEE_l1_iso04[iB] / BToKEE_fit_l1_pt[iB]);
					// hist1_23->Fill(output_BCand_iso04_l1_norm[iB]);
					// 
					// output_BCand_iso04_l2_norm.push_back(BToKEE_l2_iso04[iB] / BToKEE_fit_l2_pt[iB]);
					// hist1_24->Fill(output_BCand_iso04_l2_norm[iB]); 
					// 
					// output_BCand_iso04_trk1_norm.push_back(BToKEE_k_iso04[iB] / BToKEE_fit_k_pt[iB]);
					// hist1_25->Fill(output_BCand_iso04_trk1_norm[iB]); 
					// 
					// output_BCand_iso04_trk2_norm.push_back(-1);
					// hist1_26->Fill(output_BCand_iso04_trk2_norm[iB]); 
					// 
					// output_BCand_dR_ll.push_back(l1p4.DeltaR(l2p4));
					// hist1_27->Fill(output_BCand_dR_ll[iB]);
					// 
					// output_BCand_dR_l1trk1.push_back(l1p4.DeltaR(Kp4));
					// hist1_28->Fill(output_BCand_dR_l1trk1[iB]);
					// 
					// output_BCand_dR_l1trk2.push_back(-1);
					// hist1_29->Fill(output_BCand_dR_l1trk2[iB]);
					// 
					// output_BCand_dR_l2trk1.push_back(l2p4.DeltaR(Kp4));
					// hist1_30->Fill(output_BCand_dR_l2trk1[iB]);
					// 
					// output_BCand_dR_l2trk2.push_back(-1);
					// hist1_31->Fill(output_BCand_dR_l2trk2[iB]);
					// 
					// output_BCand_dR_trk1trk2.push_back(-1);
					// hist1_32->Fill(output_BCand_dR_trk1trk2[iB]);
					// 
					// output_BCand_dz_l1trk1.push_back(Electron_vz[l1_index] - ProbeTracks_vz[k_index]);
					// hist1_33->Fill(output_BCand_dz_l1trk1[iB]);
					// 
					// output_BCand_dz_l1trk2.push_back(-99);
					// hist1_34->Fill(output_BCand_dz_l1trk2[iB]);
					// 
					// output_BCand_dz_l2trk1.push_back(Electron_vz[l2_index] - ProbeTracks_vz[k_index]);
					// hist1_35->Fill(output_BCand_dz_l2trk1[iB]);
					// 
					// output_BCand_dz_l2trk2.push_back(-99);
					// hist1_36->Fill(output_BCand_dz_l2trk2[iB]);
					// 
					// output_BCand_dz_trk1trk2.push_back(-99);
					// hist1_37->Fill(output_BCand_dz_trk1trk2[iB]);
					// 
					// output_BCand_l1_ID.push_back(Electron_PFEleMvaID_RetrainedRawValue[l1_index]);
					// hist1_38->Fill(output_BCand_l1_ID[iB]);
					// 
					// output_BCand_l2_ID.push_back(Electron_PFEleMvaID_RetrainedRawValue[l2_index]);
					// hist1_39->Fill(output_BCand_l2_ID[iB]);

                			// output_BCand_fit_pt.push_back(BToKEE_fit_pt[iB]);
                			// hist1_12->Fill(output_BCand_fit_pt[iB]);

					// output_BCand_fit_eta.push_back(BToKEE_fit_eta[iB]);
                			// // hist1_->Fill(output_BCand_fit_eta[iB]);

					// output_BCand_fit_phi.push_back(BToKEE_fit_phi[iB]);
                			// // hist1_->Fill(output_BCand_fit_phi[iB]);

                			// output_BCand_svprob.push_back(BToKEE_svprob[iB]);
                			// hist1_15->Fill(output_BCand_svprob[iB]);

                			// output_BCand_Lxy.push_back(BToKEE_l_xy[iB]);
                			// // hist1_->Fill(output_BCand_Lxy[iB]);
					// 
					// output_BCand_Lxy_unc.push_back(BToKEE_l_xy_unc[iB]);
                			// // hist1_->Fill(output_BCand_Lxy_unc[iB]);

					// output_BCand_fit_cos2D.push_back(BToKEE_fit_cos2D[iB]);
                			// hist1_17->Fill(output_BCand_fit_cos2D[iB]);

                			// output_BCand_iso04_l1.push_back(BToKEE_l1_iso04[iB]);
                			// // hist1_->Fill(output_BCand_iso04_l1[iB]);

                			// output_BCand_iso04_l2.push_back(BToKEE_l2_iso04[iB]);
                			// // hist1_->Fill(output_BCand_iso04_l2[iB]);

                			// output_BCand_iso04_trk1.push_back(BToKEE_k_iso04[iB]);
                			// // hist1_->Fill(output_BCand_iso04_trk1[iB]);

					// output_BCand_iso04.push_back(BToKEE_b_iso04[iB]);
                			// // hist1_->Fill(output_BCand_iso04[iB]);

					// output_BCand_vtx_x.push_back(BToKEE_vtx_x[iB]);
					// // hist1_->Fill(output_BCand_vtx_x[iB]);

					// output_BCand_vtx_y.push_back(BToKEE_vtx_y[iB]);
                			// // hist1_->Fill(output_BCand_vtx_y[iB]);

					// output_BCand_vtx_z.push_back(BToKEE_vtx_z[iB]);
                			// // hist1_->Fill(output_BCand_vtx_z[iB]);

					// output_BCand_k_svip3d.push_back(BToKEE_k_svip3d[iB]);
                			// // hist1_->Fill(output_BCand_k_svip3d[iB]);

					// output_BCand_k_svip3d_err.push_back(BToKEE_k_svip3d_err[iB]);
                			// // hist1_->Fill(output_BCand_k_svip3d_err[iB]);
		}

		// hist1_43->Fill(output_run);
		// hist1_44->Fill(output_luminosityBlock);
		// hist1_45->Fill(output_event);
		// hist1_46->Fill(output_bunchCrossing);			
...
void analyzer_Data_131_triplets(TString filename, std::string outpath, int ifile, int mode) {
    ...
    TH1F* hist1_1 = new TH1F("hist1_1", "B mass", 1000, 4.2, 6.2);
		...
		// TString outname = "/eos/cms/store/group/phys_bphys/DiElectronX/sgottlie/BDT4/samesign/outputHits_" + std::to_string(ifile) + ".root";
